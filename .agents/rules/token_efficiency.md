...
- Never read or ingest files excluded by `.geminiignore` (e.g. `*.svg`, generated Prisma client runtimes, `package-lock.json`, binary files, database WAL journals, or build outputs).
